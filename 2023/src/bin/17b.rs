    ...
    fn neighbours(&self, dir: Dir) -> Vec<(Self, Dir)> {
        match dir {
            Dir::N(d) => {
                ...
                if d >= 3 {
                    v.push((Self(self.0, self.1 - 1), Dir::W(0)));
                    v.push((Self(self.0, self.1 + 1), Dir::E(0)));
                }
                if d < 9 {
            ...
            Dir::W(d) => {
                let mut v = vec![];
                if d >= 3 {
                    v.push((Self(self.0 - 1, self.1), Dir::N(0)));
                    v.push((Self(self.0 + 1, self.1), Dir::S(0)));
                }
                if d < 9 {
